  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {projectsSection.items.map((project: ProjectItem, index: number) => (
          <div
            key={index}
          ...
          >
            ...
            {project.features && project.features.length > 0 && (
              <ul className="list-disc list-inside text-gray-400 text-sm mb-4" aria-label={`${project.title} features`}>
