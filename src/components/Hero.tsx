      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-16">
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-8 md:p-12 shadow-2xl">
          ...
          <p className="text-center text-white/70 text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
            I build robust and scalable web applications, specializing in modern frontend frameworks and efficient backend solutions. My passion lies in crafting exceptional user experiences and delivering elegant solutions to complex engineering challenges.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
            ...
            <a
              href="/resume/Shubham-Mehrotra-Resume.pdf"
              download
